...
const NoteState=({children})=>{
    ...
    const[selectedLanguage,setSelectedLanguage]=useState({ languageId: "71", languageName: "Python (3.8.1)",languageEditor:"python"});
  ...
  return (
    <NoteContext.Provider value={{code,setCode,selectedLanguage,setSelectedLanguage,submit,setSubmit,output,setOutput,language,input,setInput}}>
    {children}
